...
EXAMUS_INVOLVEMENT_ENABLED = str(os.getenv('EXAMUS_INVOLVEMENT_ENABLED', False)) == 'True'
EXAMUS_INVOLVEMENT_TOKEN_NAME = os.getenv('EXAMUS_INVOLVEMENT_TOKEN_NAME', 'replace-me')
