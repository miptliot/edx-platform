...
RECALCULATE_VERTICAL_GRADES_ROUTING_KEY = ENV_TOKENS.get('RECALCULATE_VERTICAL_GRADES_ROUTING_KEY', RECALCULATE_GRADES_ROUTING_KEY)
if RECALCULATE_VERTICAL_GRADES_ROUTING_KEY not in CELERY_QUEUES:
    CELERY_QUEUES[RECALCULATE_VERTICAL_GRADES_ROUTING_KEY] = {}
